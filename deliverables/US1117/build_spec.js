...
[
  ...
  "SAM gets itself set up — first permissions, then NFC: “Tap here, turn on everything SAM OnSite needs, then come back and type done.” Each link opens the right place in the phone’s settings (the app’s settings page, where they tap Permissions; then the NFC switch that reads checkpoint tags); the guard turns things on, comes back, and says or types “done.” SAM checks each item itself — naming anything wrong and linking back, or moving on.",
